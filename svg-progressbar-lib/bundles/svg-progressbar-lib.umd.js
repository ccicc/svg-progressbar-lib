(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('svg-progressbar-lib', ['exports', '@angular/platform-browser', '@angular/core', '@angular/common'], factory) :
    (factory((global['svg-progressbar-lib'] = {}),global.ng.platformBrowser,global.ng.core,global.ng.common));
    ...
    var SvgProgressbarLibService = /** @class */ (function () {
        ...
        /** @nocollapse */
        SvgProgressbarLibService.ctorParameters = function () {
            return [
    ...
    /** @type {?} */
    var SVG_PROGRESSBAR_LIB_CONFIG = new core.InjectionToken('SVG_PROGRESSBAR_LIB_CONFIG');
    /** @type {?} */
    ...
    var SvgProgressbarLibComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        SvgProgressbarLibComponent.ctorParameters = function () {
            return [
                { type: SvgProgressbarLibService },
                { type: SvgProgressbarLibEase },
                { type: core.Renderer2 },
                { type: core.NgZone },
                { type: undefined, decorators: [{ type: core.Inject, args: [SVG_PROGRESSBAR_LIB_CONFIG,] }] }
            ];
        };
        SvgProgressbarLibComponent.propDecorators = {
            valueChanged: [{ type: core.Output }],
            pathEle: [{ type: core.ViewChild, args: ['path',] }],
            radius: [{ type: core.Input }],
            semicycle: [{ type: core.Input }],
            color: [{ type: core.Input }],
            background: [{ type: core.Input }],
            strokeWidth: [{ type: core.Input }],
            rounded: [{ type: core.Input }],
            currVal: [{ type: core.Input }],
            total: [{ type: core.Input }],
            duration: [{ type: core.Input }],
            animation: [{ type: core.Input }],
            delay: [{ type: core.Input }],
            clockwise: [{ type: core.Input }],
            responsive: [{ type: core.Input }, { type: core.HostBinding, args: ['class.responsive',] }],
            _role: [{ type: core.HostBinding, args: ['attr.role',] }],
            _width: [{ type: core.HostBinding, args: ['style.width',] }],
            _height: [{ type: core.HostBinding, args: ['style.height',] }],
            _paddingBottom: [{ type: core.HostBinding, args: ['style.padding-bottom',] }]
        };
    ...
    exports.SvgProgressbarLibService = SvgProgressbarLibService;
    exports.SvgProgressbarLibComponent = SvgProgressbarLibComponent;
    exports.SvgProgressbarLibModule = SvgProgressbarLibModule;
    exports.SvgProgressbarLibDefaults = SvgProgressbarLibDefaults;
    exports.SVG_PROGRESSBAR_LIB_CONFIG = SVG_PROGRESSBAR_LIB_CONFIG;
    exports.SVG_PROGRESSBAR_LIB_PROVIDER = SVG_PROGRESSBAR_LIB_PROVIDER;
    exports.SvgProgressbarLibEase = SvgProgressbarLibEase;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=svg-progressbar-lib.umd.js.map