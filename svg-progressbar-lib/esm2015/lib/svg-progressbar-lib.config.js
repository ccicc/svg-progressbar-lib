...
/** @type {?} */
export const SvgProgressbarLibDefaults = {
    radius: 100,
    semicycle: false,
    color: '#666699',
    background: '#cccccc',
